...
#gpus=  [[0]]# [[0],[1], [2], [3], [4], [5], [6], [7]] #[[0],[1],[2],[3]]
num_p = len(gpus)
outdir = '{}/qwen2_{}_{}_mufp16'.format(args.outdir,s,e)
...
for i in range(num_p):
    ...
    command = "python3 ge_data_all_qwen2.py --start={} --end={} --index={} --gpu_index {} --outdir {}".format(start, end, index,
